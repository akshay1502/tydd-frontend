export default function IconFeature({ color }: { color: string }) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path
        d="M21.96 14.8702C21.9 16.0502 20.92 17.0002 19.72 17.0002C18.48 17.0002 17.47 15.9902 17.47 14.7502V11.5302L19.5 11.9802C20.82 12.2702 21.9 12.9502 21.96 14.8702Z"
        stroke={color}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"

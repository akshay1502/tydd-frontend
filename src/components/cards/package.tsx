...
export default function Packages({
  ...
  return (
    <Link
      ...
      className={`group flex flex-col lg:gap-2 gap-1 ${
        smallVariant ? "w-auto" : "w-48"
      }`}
    >
      <div className="relative rounded-lg overflow-hidden shadow-packages">
        <div
          className={`${
            smallVariant ? "w-full aspect-square" : "w-48 h-48"
          } relative`}
        >
          <Image
            src={
      ...
      <p className="text-black lg:text-base text-xs mt-1 lg:mt-0">
        {data?.package}
      </p>
